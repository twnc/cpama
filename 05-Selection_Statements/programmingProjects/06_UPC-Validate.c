...
int main(void)
{
	int d, i1, i2, i3, i4, i5, j1, j2, j3, j4, j5, check_digit, first_sum, second_sum, total, verified_check_digit;
	...
	verified_check_digit = 9 - ((total - 1) % 10);

	printf("Check digit: %d\n", verified_check_digit);

	if(check_digit == verified_check_digit)
		printf("VALID\n");
	else
		printf("NOT VALID\n");
